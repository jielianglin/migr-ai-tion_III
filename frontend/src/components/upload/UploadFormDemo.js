...
export default function UploadFormDemo() {
                ...
                <div style={style9}>
                    <Grid container spacing={9}>
                        <Grid item xs={12} md={6}>
                            <Typography style={style8}>
                                {' '}
                                Success! Now compare your tags to the AI tags
                                from ImageNet.
                            </Typography>
                            <div style={style10}>
                                <btn style={style16}>
                    ...
                    <Stack spacing={2} direction='row' style={style3}>
                        ...
                        <Popover
                            ...
                            <Typography>
                                ...
                                <b>
                                    <i>
                                        The following section is for demo
                                        purposes only.
                                    </i>
                                </b>{' '}
                                <br />
                                The database is currently under construction.{' '}
                                <br /> Click "Submit" to see our designs.
                            </Typography>
                        </Popover>
